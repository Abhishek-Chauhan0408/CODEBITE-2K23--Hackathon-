 ...
 document.querySelector("#overlay1").addEventListener("mousemove",function(dets){
    ...
    b.style.opacity=0;
    document.querySelector("#elem1 img").style.left=(dets.x-450)+"px";
    document.querySelector("#elem1 img").style.top=(dets.y-200)+"px";
 })
...
document.querySelector("#overlay2").addEventListener("mousemove",function(dets){
   ...
   document.querySelector("#elem2 img").style.top=(dets.y-210)+"px";
})
...
document.querySelector("#overlay3").addEventListener("mousemove",function(dets){
   ...
   document.querySelector("#elem3 img").style.left=(dets.x-1000)+"px";
